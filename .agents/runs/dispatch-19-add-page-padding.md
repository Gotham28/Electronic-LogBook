...
## Model
Claude Sonnet 4.6 (Thinking) if available; Gemini 3.1 Pro (High) if Claude tiers are still
quota-limited — this is a small, well-scoped visual fix, not new design judgment.
