...
job_id (attempt 1): d46806de0abf40edb5a4e4e263562355 — model: Claude Sonnet 4.6 (Thinking).
  BLOCKED — "Individual quota reached... Resets in 23h51m59s." Same account-wide quota
  bucket as every other Claude-tier block this session.
job_id (attempt 2): cac3872816a94efeb9ebcd95b2639b56 — model: Gemini 3.1 Pro (High),
