...
export async function applyMigrations(connection: MigrationConnection, adoptExisting = false) {
  ...
  const files = ["0001_baseline.sql", "0002_departments_assignments.sql", "0003_subscriptions_payments.sql", "0004_mirror_test_department.sql", "0005_case_log_category.sql", "0006_department_config_nullable_and_features.sql", "0007_conferences.sql"];
